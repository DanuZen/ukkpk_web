...
>>>>>>> 2d7426f205188a689f407b8b06fc02eb1bd0e00a
      {children}
    </div>;
};
const ProfilUkkpk = () => {
        ...
        {profile?.banner_url && (
          <section className="relative w-full min-h-[60vh] overflow-hidden flex items-center">
            ...
            <div className="absolute bottom-8 left-0 right-0 text-center">
              <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white drop-shadow-lg">Profil UKKPK</h1>
            </div>
          </section>
        )}
            ...
            <div className="container mx-auto relative z-10">
              <AnimatedSection animation="fade-up">
                <div className="max-w-3xl mx-auto text-center space-y-6">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-primary via-primary to-black/80 bg-clip-text text-transparent">UKKPK UNP</h1>
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground">Unit Kegiatan Komunikasi dan Penyiaran Kampus Universitas Negeri Padang</p>
                </div>
              </AnimatedSection>
            </div>
          </section>
              ...
              <AnimatedSection animation="fade-up">
                <div className="text-center mb-12">
                  <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1 sm:py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
                    ...
                    <span className="text-[10px] sm:text-sm font-medium text-primary">Tentang Kami</span>
                  </div>
                  <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-primary to-black/80 bg-clip-text text-transparent">Profil UKKPK</h2>
                  ...
                  <CardContent className="pt-10 pb-10 px-8 md:px-12 relative">
                    ...
                    <div className="relative z-10">
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed text-justify">
                        ...
                        menghibur. Ketiga bidang ini saling melengkapi untuk menjadikan UKKPK sebagai wadah pengembangan bakat mahasiswa dalam dunia komunikasi dan penyiaran.
                      </p>
                    </div>
                  </CardContent>
                </Card>
              ...
              <AnimatedSection animation="fade-up">
                <div className="text-center mb-12">
                  <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1 sm:py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
                    ...
                    <span className="text-[10px] sm:text-sm font-medium text-primary">Visi & Misi</span>
                  </div>
                  <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-primary to-black/80 bg-clip-text text-transparent">Arah & Tujuan</h2>
                  <div className="w-20 h-1 bg-gradient-to-r from-transparent via-primary to-transparent mx-auto" />
                </div>
              </AnimatedSection>
                  ...
                  <Card className="bg-white border-primary/20 shadow-xl overflow-hidden transition-all duration-500">
                    <CardContent className="pt-8 pb-8 relative">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Visi</h3>
                      </div>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed text-justify">
                  ...
                  <Card className="bg-white border-primary/20 shadow-xl overflow-hidden transition-all duration-500">
                    <CardContent className="pt-8 pb-8 relative">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Misi</h3>
                      </div>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed text-justify">
            ...
            <div className="max-w-6xl mx-auto">
              <AnimatedSection animation="fade-up" delay={100}>
                <div className="text-center mb-12">
                  ...
                  <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-primary to-black/80 bg-clip-text text-transparent">Sejarah UKKPK</h2>
                  <div className="w-20 h-1 bg-gradient-to-r from-transparent via-primary to-transparent mx-auto" />
                </div>
              </AnimatedSection>
                  ...
                  <Card className="bg-white border-primary/20 shadow-xl overflow-hidden transition-all duration-500">
                    <CardContent className="pt-8 pb-8 relative">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Awal Terbentuk (1993)</h3>
                      </div>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed text-justify">
                        UKKPK (Unit Kegiatan Komunikasi dan Penyiaran Kampus) merupakan salah satu unit kegiatan mahasiswa (UKM) yang ada di Universitas Negeri Padang (UNP). UKM ini merupakan fusi tiga UKM, yaitu UK MC, UK Radio, dan UK
                        Penerbitan Kampus, yang telah ada sebelumnya di IKIP Padang. Pada tahun 1993 ketiga tersebut bergabung dan membentuk satu kesatuan dengan nama Unit Kegiatan Komunikasi dan Penerbitan Kampus (UKKPK) IKIP Padang. Namun
                        seiring perkembangan dan kondisi waktu, pada tahun 2000 dalam MUBES III UKKPK UNP berganti nama menjadi Unit Kegiatan Komunikasi dan Penyiaran Kampus namun tetap menggunakan akronim UKKPK.
                      </p>
                    </CardContent>
                  </Card>
                </AnimatedSection>
                  ...
                  <Card className="bg-white border-primary/20 shadow-xl overflow-hidden transition-all duration-500">
                    <CardContent className="pt-8 pb-8 relative">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Perkembangan Organisasi (1993-2000)</h3>
                      </div>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed text-justify">
                        Pada masa awal berdirinya, UKKPK fokus mengembangkan tiga bidang utama: MC dan Public Speaking, Penerbitan Kampus, dan Penyiaran Radio. Ketiga bidang ini menjadi fondasi kuat bagi pengembangan keterampilan komunikasi
                  ...
                  <Card className="bg-white border-primary/20 shadow-xl overflow-hidden transition-all duration-500">
                    <CardContent className="pt-8 pb-8 relative">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Transformasi Modern (2000-2015)</h3>
                      </div>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed text-justify">
                        Memasuki era digital, UKKPK mulai mengadaptasi teknologi modern dalam kegiatan penyiaran dan jurnalistik. Bidang penerbitan bertransformasi menjadi jurnalistik digital, dan radio kampus mulai mengadopsi teknologi
                        streaming online. Perubahan ini menandai era baru UKKPK dalam menghadapi perkembangan zaman.
                      </p>
                    </CardContent>
                  </Card>
                </AnimatedSection>
                  ...
                  <Card className="bg-white border-primary/20 shadow-xl overflow-hidden transition-all duration-500">
                    <CardContent className="pt-8 pb-8 relative">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Ekspansi Bidang (2015-2020)</h3>
                      </div>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed text-justify">
                        UKKPK terus berkembang dengan menambah berbagai bidang baru seperti Kewirausahaan, Kesekretariatan, Human Resource Development, dan Public Relations. Ekspansi ini bertujuan untuk memberikan pengalaman yang lebih
                        komprehensif kepada anggota dalam berbagai aspek komunikasi dan organisasi.
                      </p>
                    </CardContent>
                  </Card>
                </AnimatedSection>
                  ...
                  <Card className="bg-white border-primary/20 shadow-xl overflow-hidden transition-all duration-500">
                    <CardContent className="pt-8 pb-8 relative">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Era Digital & Inovasi (2020-Sekarang)</h3>
                      </div>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed text-justify">
                        Di era pandemi dan pasca pandemi, UKKPK semakin memperkuat kehadiran digitalnya. Berbagai inovasi seperti webinar, podcast, konten media sosial, dan kolaborasi lintas platform menjadi fokus utama. UKKPK terus
                        beradaptasi dan berinovasi untuk tetap relevan di tengah perkembangan teknologi komunikasi yang pesat.
                      </p>
                    </CardContent>
                  </Card>
                </AnimatedSection>
          ...
          <div className="container mx-auto relative z-10">
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-12">
                ...
                <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-primary to-black/80 bg-clip-text text-transparent">Bidang Kegiatan</h2>
=======
    const {
      data
            ...
            <AnimatedSection animation="fade-up">
              ...
              <div className="inline-block mb-4">
                <span className="text-[10px] md:text-xs font-semibold text-primary tracking-wider uppercase flex items-center gap-1.5">
                  <Users className="w-2.5 h-2.5 md:w-3 md:h-3 animate-pulse" />
                  TENTANG KAMI
                </span>
              </div>
                  ...
                  <AnimatedSection key={index} animation="fade-up" delay={100 + index * 100}>
                    <Card className="group transition-all duration-300 hover:-translate-y-1 shadow-lg">
                      <CardContent className="pt-6 text-center flex flex-col items-center">
                        <div className="inline-flex p-3 sm:p-4 rounded-full bg-primary/10 text-primary mb-4 group-hover:scale-110 transition-transform">{feature.icon}</div>
                        <h3 className="text-sm sm:text-base md:text-lg font-semibold mb-3 min-h-[3rem] flex items-center justify-center">{feature.title}</h3>
                        <p className="text-xs sm:text-sm md:text-base text-muted-foreground text-center leading-relaxed">{feature.description}</p>
                      </CardContent>
                    </Card>
                  </AnimatedSection>
                ))}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {values.map((value, index) => <AnimatedSection key={index} animation="scale-in" delay={100 + index * 150}>
                  <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 shadow-lg">
                    ...
                    <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 relative z-10">
                      {value.title}
                    </h3>
                    <p className="text-sm sm:text-base md:text-lg text-muted-foreground text-center leading-relaxed relative z-10">
                      {value.description}
...
>>>>>>> 2d7426f205188a689f407b8b06fc02eb1bd0e00a
                ...
                <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-primary to-black/80 bg-clip-text text-transparent">Nilai-Nilai</h2>
                <div className="w-20 h-1 bg-gradient-to-r from-transparent via-primary to-transparent mx-auto" />
              </div>
<<<<<<< HEAD
            </AnimatedSection>
                ...
                <AnimatedSection key={index} animation="scale-in" delay={100 + index * 150}>
                  <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 shadow-lg">
                    <CardContent className="pt-6">
                      <div className="inline-flex p-2.5 sm:p-3 rounded-full bg-primary/10 text-primary mb-4">{value.icon}</div>
                      <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2">{value.title}</h3>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground text-center leading-relaxed">{value.description}</p>
                    </CardContent>
                  </Card>
                </AnimatedSection>
              ))}
            ...
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1 sm:py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
                  ...
                  <span className="text-[10px] sm:text-sm font-medium text-primary">Tim Kami</span>
                </div>
                <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-primary to-black/80 bg-clip-text text-transparent">Struktur Organisasi</h2>
                <div className="w-20 h-1 bg-gradient-to-r from-transparent via-primary to-transparent mx-auto" />
              </div>
            </AnimatedSection>
                  ...
                  <AnimatedSection key={member.id} animation="fade-up" delay={100 + (index % 3) * 100}>
                    <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-sm sm:text-base md:text-lg font-semibold mb-1">{member.name}</h3>
