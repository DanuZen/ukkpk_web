          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-6 lg:gap-8 items-stretch">
            ...
            <AnimatedSection animation="fade-up" delay={200}>
              <Card className="h-full">
                ...
                <CardContent className="space-y-3 sm:space-y-4 md:space-y-6 p-3 pt-0 sm:p-4 sm:pt-0 md:p-6 md:pt-0">
                  <div>
                    <h3 className="font-semibold text-xs sm:text-sm md:text-base mb-1 sm:mb-1.5 md:mb-2">Alamat Lengkap</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-xs sm:text-sm md:text-base mb-1 sm:mb-1.5 md:mb-2">Kontak</h3>
                    <div className="space-y-1 sm:space-y-1.5 md:space-y-2 text-muted-foreground text-[10px] sm:text-xs md:text-sm">
                      ...
                      <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 pt-1 sm:pt-1.5 md:pt-2">
                        <a 
                          ...
                          className="inline-flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-green-500 text-white hover:bg-green-600 transition-colors"
                          aria-label="WhatsApp"
                        >
                        ...
                        <a 
                          ...
                          className="inline-flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
                          aria-label="Email"
                        >
                          <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                  ...
                  <div>
                    <h3 className="font-semibold text-xs sm:text-sm md:text-base mb-1 sm:mb-1.5 md:mb-2">Jam Operasional</h3>
                    <div className="space-y-0.5 sm:space-y-1 text-muted-foreground text-[10px] sm:text-xs md:text-sm">
