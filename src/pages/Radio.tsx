  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data: settingsData } = await supabase.from('radio_settings').select('streaming_url, banner_image_url').single();
          ...
          <AnimatedSection animation="fade-up">
            <div className="max-w-3xl mx-auto text-center space-y-4 sm:space-y-6">
              ...
              <div className="overflow-hidden inline-block max-w-full">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white whitespace-nowrap inline-block drop-shadow-2xl typewriter-text">SIGMA RADIO</h1>
              </div>
              <style>{`
                .typewriter-text {
                  width: 0;
              ...
              {currentProgram ? (
                <div key={currentProgram.id} className="mb-6 sm:mb-8 p-4 sm:p-6 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl animate-fade-in">
                ...
                <div className="mb-6 sm:mb-8 p-4 sm:p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl">
          ...
          <div id="jadwal-program" className="relative scroll-mt-20">
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-12">
                ...
                <p className="text-xs sm:text-base md:text-lg text-muted-foreground max-w-3xl mx-auto mb-6">Lihat jadwal lengkap program radio UKKPK dan jangan lewatkan program favorit Anda</p>
                    ...
                    <Card className="group relative overflow-hidden border-border/40 hover:border-primary/40 transition-all duration-500 shadow-lg hover:shadow-2xl hover:shadow-primary/10 bg-white dark:bg-gray-900 h-full flex flex-col">
                      ...
                      <CardHeader className="relative px-4 py-4 sm:px-6 sm:py-5 md:px-8 md:py-6">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <CardTitle className="text-base sm:text-lg md:text-xl font-bold mb-2 group-hover:text-primary transition-colors duration-300">{program.name}</CardTitle>
