import { Mail, Phone, MapPin, Facebook, Instagram, Youtube, MoreHorizontal } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 items-center">
              <a href="https://web.facebook.com/p/UKKPK-UNP-100063495233989/?_rdc=1&_rdr#" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-all duration-300 hover:scale-110 hover:shadow-primary">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="https://www.instagram.com/ukkpk_unp/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-all duration-300 hover:scale-110 hover:shadow-primary">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="https://www.youtube.com/@UKKPKUNP" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-all duration-300 hover:scale-110 hover:shadow-primary">
                <Youtube className="h-5 w-5" />
              </a>
              <button className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-all duration-300 hover:scale-110 hover:shadow-primary">
