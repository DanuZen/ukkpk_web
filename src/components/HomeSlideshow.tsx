...
export const HomeSlideshow = () => {
  ...
  if (images.length === 0) {
    return (
      <section className="relative w-screen h-[calc(95vh+4rem)] md:h-[calc(100dvh+4rem)] max-w-[100vw] overflow-hidden bg-gradient-to-br from-primary/20 via-background to-secondary/20 -mt-16">
  ...
  return (
    <section className="relative w-screen h-[calc(95vh+4rem)] md:h-[calc(100dvh+4rem)] max-w-[100vw] overflow-hidden group -mt-16">
      {/* Slideshow Images */}
