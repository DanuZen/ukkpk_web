  ...
  ({ className, onClick, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        variant="ghost"
        size="icon"
        className={cn("h-7 w-7 hover:bg-primary hover:text-primary-foreground", className)}
        onClick={(event) => {
          onClick?.(event);
          toggleSidebar();
        }}
