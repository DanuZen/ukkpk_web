          ...
          {testimonials.length > 1 && (
            <>
              <Button
                variant="outline"
                size="icon"
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 md:-translate-x-16 rounded-full w-12 h-12 bg-transparent hover:bg-gray-200/50 border-0 transition-colors duration-300"
                onClick={prevSlide}
              >
              ...
              <Button
                variant="outline"
                size="icon"
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 md:translate-x-16 rounded-full w-12 h-12 bg-transparent hover:bg-gray-200/50 border-0 transition-colors duration-300"
                onClick={nextSlide}
              >
